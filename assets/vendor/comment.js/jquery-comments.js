...
(function (factory) {
    ...
    var Comments = {
        ...
        getDefaultOptions: function() {
            return {
                ...
                timeFormatter: function(time) {
                    ...
                    let times = new Date(time).toLocaleTimeString();
                    return date +'  '+ times;
                  }
            }
        },
        ...
        putComment: function(ev) {
            ...
            let dNow = new Date();
            let mes =  dNow.getMonth()
            mes = mes +1;
            let localdate= (dNow.getFullYear() + '-' + mes + '-' + dNow.getDate() + ' ' + dNow.getHours() + ':' + dNow.getMinutes()+ ':' + dNow.getSeconds());
            $.extend(commentJSON, {
