<div id="content-wrapper">
  <div class="container-fluid mb-5">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active">Nosotros / Políticas</li>
    </ol>
    ...
    <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i>
         Lista de políticas
        <button class="btn btn-secondary float-right" type='button' data-toggle="modal" data-target="#create_policies_modal" id="btn_create_policies"><i class="fas fa-plus"></i> Agregar política</button>
      </div>
      <div class="card-body">
      <div class="table-responsive">
          <table class="table table-bordered" id="table-policies" width="100%" cellspacing="0">
            <thead>
              <tr>
                <th>Nombre</th>
                <th>Editar</th>
...
<div class="modal fade bd-example-modal-lg" id="create_policies_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="title">Agregar política</h5>
                        ...
                        <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mb-3">
                                                ...
                                                <div div class="input-group" id="frm_name2">
                                                    <textarea class="form-control"  name="description" id="description" placeholder="Ingrese nombre"></textarea>
                                                    <div class="invalid-feedback "></div>
                                                </div>
                                    ...
                                    <div class="form-group float-right">
                                        <button type="button" id="create_policies_btn" class="btn btn-primary">Guardar</button>
                                    </div>
                        </div>
                </div>
  </div>
...
<div class="modal fade bd-example-modal-lg" id="edit_policies_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >Editar política</h5>
                <button type="button" class="close"  data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
                        ...
                        <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 mb-3">
                                                <label for="actividad">Descripción</label>
                                                <div div class="input-group" id="frm_name2">
                                                    <textarea class="form-control"  name="description" id="description-edit" placeholder="Ingrese nombre"></textarea>
                                                    <div class="invalid-feedback "></div>
                                                </div>
                                    ...
                                    <div class="form-group float-right">
                                        <button type="button" id="edit_policies_btn" class="btn btn-primary">Guardar</button>
                                    </div>
                        </div>
                </div>
  </div>
...
<script src="<?php echo base_url(); ?>assets/js_admin/adminPolicies.js"></script>