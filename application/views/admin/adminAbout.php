<div id="content-wrapper">
  <div class="container-fluid mb-5">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active">Nosotros/ Hidratec</li>
    </ol>
...
<!--
    ...
    <div class="card mb-3">
      <div class="card-header">
        <i class="fas fa-table"></i>
         Carousel de personal (Representantes)
        <button class="btn btn-dark float-right" type='button' data-toggle="modal" data-target="#create_personal_modal" id="modal_create_personal"><i class="fas fa-plus"></i> Agregar personal</button>
      </div>
      <div class="card-body">
      <div class="table-responsive">
          <table class="table table-bordered" id="table-personal" width="100%" cellspacing="0">
            <thead>
              <tr>
                <th>Nombre</th>
                <th>Área</th>
...
<div class="modal fade bd-example-modal-lg" id="create_personal_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="title">Agregar personal</h5>
        ...
        <form  id= "image" >
              <div class="row">
                  <div class="col-md-6 mb-3">
                        <label for="actividad">Nombre del personal</label>
                        <div div class="input-group" id="frm_name2">
                            <input type="text" class="form-control"  name="name" id="name-personal" placeholder="Ingrese nombre">
                            <div class="invalid-feedback "></div>
                        </div>
                        
                  </div>
                  <div class="col-md-6 mb-3">
                        <label for="actividad">Área del personal</label>
                        <div div class="input-group" id="frm_name2">
                            <input type="text" class="form-control"  name="name" id="area" placeholder="Ingrese area">
                            <div class="invalid-feedback "></div>
                        </div>
                        
                  </div>
                  <div class="col-md-12 mb-3">
                        <label for="actividad">Cita del personal</label>
                        <div div class="input-group" id="frm_name2">
                            <input type="text" class="form-control"  maxlength="92" name="name"  id="phrase" placeholder="Ingrese cita o frase">
                            <div class="invalid-feedback "></div>
                        </div>
                ...
                <div class="row">
                   ...
                   <div class="form-group float-right">
                       <button type="button" id="create_personal_btn" class="btn btn-primary">Guardar</button>
                  </div>
                </div>
                </div>
                </div>
...
<div class="modal fade bd-example-modal-lg" id="edit_personal_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="title">Editar personal</h5>
        <button type="button" class="close"  data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="form-group">
              ...
              <div class="row">
                  <div class="col-md-6 mb-3">
                        <label for="actividad">Nombre del personal</label>
                        <div div class="input-group" id="frm_name2">
                            <input type="text" class="form-control"  name="name" id="name-personal-edit" placeholder="Ingrese nombre">
                            <div class="invalid-feedback "></div>
                        </div>
                        
                  </div>
                  <div class="col-md-6 mb-3">
                        <label for="actividad">Área de trabajo</label>
                        <div div class="input-group" id="frm_name2">
                            <input type="text" class="form-control"  name="name" id="area-edit" placeholder="Ingrese area">
                            <div class="invalid-feedback "></div>
                        </div>
                        
                  </div>
                  <div class="col-md-12 mb-3">
                        <label for="actividad">Cita o frase </label>
                        <div div class="input-group" id="frm_name2">
                            <textarea type="text" class="form-control"  maxlength="92" name="name" id="phrase-edit" placeholder="Ingrese cita o frase"></textarea>
                            <div class="invalid-feedback "></div>
                        </div>
                ...
                <div class="row">
                   <div class="col-md-12 mb-3">
                   <div class="form-group float-right">
                       <button type="button" id="edit_personal_btn" class="btn btn-primary">Guardar</button>
                  </div>
                </div>
                </div>
                </div>
...
<script src="<?php echo base_url(); ?>assets/js_admin/adminAbout.js"></script>